...
static const uint8_t *framebuffer_glyph(char c)
{
    ...
    static const uint8_t glyph_lt[7] = {0x01, 0x02, 0x04, 0x08, 0x04, 0x02, 0x01};
    static const uint8_t glyph_lbracket[7] = {0x0e, 0x08, 0x08, 0x08, 0x08, 0x08, 0x0e};
    static const uint8_t glyph_rbracket[7] = {0x0e, 0x02, 0x02, 0x02, 0x02, 0x02, 0x0e};
    static const uint8_t glyph_lbrace[7] = {0x06, 0x08, 0x08, 0x10, 0x08, 0x08, 0x06};
    static const uint8_t glyph_rbrace[7] = {0x0c, 0x02, 0x02, 0x01, 0x02, 0x02, 0x0c};
    static const uint8_t glyph_pipe[7] = {0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04};
    static const uint8_t glyph_plus[7] = {0x00, 0x04, 0x04, 0x1f, 0x04, 0x04, 0x00};
    static const uint8_t glyph_star[7] = {0x00, 0x15, 0x0e, 0x1f, 0x0e, 0x15, 0x00};
    ...
    static const uint8_t glyph_quote[7] = {0x0a, 0x0a, 0x0a, 0x00, 0x00, 0x00, 0x00};
    static const uint8_t glyph_apostrophe[7] = {0x04, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00};
    static const uint8_t glyph_backslash[7] = {0x10, 0x10, 0x08, 0x04, 0x02, 0x01, 0x01};
    static const uint8_t glyph_comma[7] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x08};
    static const uint8_t glyph_semicolon[7] = {0x00, 0x04, 0x04, 0x00, 0x04, 0x04, 0x08};
...
static void framebuffer_console_draw_cursor(uint32_t color)
{
    unsigned int cell_width = framebuffer_console_cell_width();
    unsigned int cell_height = framebuffer_console_cell_height();
    unsigned int thickness = FRAMEBUFFER_CONSOLE_CURSOR_THICKNESS;
    unsigned int x = framebuffer_console_x();
    unsigned int y = framebuffer_console_y();
    ...
    framebuffer_fill_rect(x,
                          ...
                          thickness,
                          color);
    framebuffer_fill_rect(x + cell_width - thickness,
                          y,
                          thickness,
                          cell_height,
                          color);
...
void framebuffer_console_hide_cursor(void)
{
    ...
    framebuffer_console_clamp_cursor();
    framebuffer_console_draw_cursor(FRAMEBUFFER_CONSOLE_BG);
...
void framebuffer_console_show_cursor(void)
{
    ...
    framebuffer_console_clamp_cursor();
    framebuffer_console_draw_cursor(FRAMEBUFFER_CONSOLE_CURSOR);
